...
public class GlideRoundedCornersTransform extends BitmapTransformation {
    ...
    private static final String ID = "com.bumptech.glide" + "GlideRoundedCornersTransform." + VERSION;
    ...
    protected Bitmap transform(BitmapPool pool, Bitmap toTransform, int outWidth, int outHeight) {
        Bitmap transform = TransformationUtils.centerCrop(pool, toTransform, outWidth, outHeight);
...
//        canvas.drawColor(R.color.translate);
