        ...
        for (LINE aContentList : contentList) {
            ...
            for (int j = 0; j < aContentList.line.size(); j++) {
                ...
                if (ob instanceof String) {
                    paint.setColor(context.getResources().getColor(R.color.black_222628));
                    Log.e("TAG", "onDraw:-- "+(String) ob);
                    ...
                    {
                        Log.e("TAG", "onDraw: "+j );
                        paint.setColor(context.getResources().getColor(R.color.colorTheme));
                        Log.e("TAG", "onDraw: "+ ((SpanObject) ob).source.toString());
                        canvas.drawText(((SpanObject) ob).source.toString(),
                                realDrawedWidth, height + aContentList.height
                                        - mFontMetrics.descent, paint);
                        realDrawedWidth += width;
