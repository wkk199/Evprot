 ...
 */
public class SignUpViewModel extends ViewModel implements Request.IAccountRequest {
    ...
    public final ObservableBoolean sendCodeEnable = new ObservableBoolean(true);


    private AccountRequest mAccountRequest = new AccountRequest();

    public LiveData<User> getCheckNameLive(){
        return mAccountRequest.getCheckNameLiveData();
    }
    ...
    public void requestSignUp(User user) {
        mAccountRequest.requestSignUp(user);
    }
    ...
    public void sendEmailCode(String email,int f) {
        mAccountRequest.sendEmailCode(email, Configs.CODE_SINGUP);
    }

    @Override
    public void checkUserName(String name) {
        mAccountRequest.checkUserName(name);
    }
}
