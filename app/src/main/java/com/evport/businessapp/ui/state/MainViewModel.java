...
import com.evport.businessapp.domain.request.MusicRequest;
...
public class MainViewModel extends ViewModel implements Request.IMusicRequest {
    ...
    public final ObservableField<String> ipPort = new ObservableField<>();
    public final ObservableField<String> pingNotice = new ObservableField<>();
    public final ObservableField<Boolean> pingBtnEnable = new ObservableField<>();
