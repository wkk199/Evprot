package com.evport.businessapp.upgrade.service;
...
import com.evport.businessapp.upgrade.UpgradeConstant;
import com.evport.businessapp.upgrade.UpgradeException;
import com.evport.businessapp.upgrade.UpgradeLogger;
import com.evport.businessapp.upgrade.UpgradeUtil;
import com.evport.businessapp.upgrade.model.UpgradeRepository;
import com.evport.businessapp.upgrade.model.bean.UpgradeBuffer;
import com.evport.businessapp.upgrade.model.bean.UpgradeOptions;
import com.evport.businessapp.upgrade.receiver.NetworkStateReceiver;
import com.evport.businessapp.upgrade.receiver.PackagesReceiver;
...
public class UpgradeService extends Service {
    ...
    private void initNotify() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                ...
                builder.setContentIntent(getDefaultIntent(PendingIntent.FLAG_UPDATE_CURRENT));
            }
        } else {
    ...
    private void sendMessageToClient(int code, Bundle data, Messenger client) {
        try {
            ...
            UpgradeLogger.e(TAG, "Send message failure", e);
        }
    }
    ...
    private static class ServerHandler extends Handler {
        private final SoftReference<UpgradeService> reference;
    ...
    private static class MessageHandler extends Handler {
        private final WeakReference<UpgradeService> reference;
