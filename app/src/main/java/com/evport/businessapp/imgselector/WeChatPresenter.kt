package com.nkr.home.ui.imgselector
...
import com.evport.businessapp.utils.getString
...
class WeChatPresenter : IPickerPresenter {
    ...
    override fun getUiConfig(context: Context?): PickerUiConfig {
        ...
        //设置主题色
        uiConfig.themeColor = Color.parseColor("#0DA79B")
        //设置是否显示状态栏
        uiConfig.isShowStatusBar = true
        //设置状态栏颜色
        uiConfig.statusBarColor = Color.parseColor("#FFFFFF")
        //设置选择器背景
    ...
    override fun showProgressDialog(
        ...
        return ProgressDialog.show(
            activity,
            null,
            if (progressSceneEnum == ProgressSceneEnum.crop) getString(R.string.clipping) else getString(R.string.Loading)
        )
    }
    ...
    override fun interceptPickerCancel(
        ...
        val builder = AlertDialog.Builder(WeakReference(activity).get()!!)
        builder.setMessage(getString(R.string.up_the_choice))
        builder.setPositiveButton(
            R.string.picker_str_sure
        ) { dialogInterface, i ->
            dialogInterface.dismiss()
            activity.finish()
        }
        builder.setNegativeButton(
            R.string.picker_str_error
