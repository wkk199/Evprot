 ...
 */
public class RecordRequest implements Request.IRecordRequest {

    private MutableLiveData<List<RecordResp>> mRecordLiveData;
    ...
    public LiveData<List<RecordResp>> getRecordLiveData() {
        ...
        if (mRecordLiveData == null) {
            mRecordLiveData = new MutableLiveData<>();
        }
    ...
    public void requestRecord(RequestRecord requestRecord) {
        ...
        DataRepository.Companion.getInstance().getRecords(requestRecord, mRecordLiveData);
    }
