 ...
 */
public class StatsRequest implements Request.IStatsRequest {

    private MutableLiveData<StatsDataResp> mStatsLiveData;
    ...
    public LiveData<StatsDataResp> getStatsLiveData() {
        ...
        if (mStatsLiveData == null) {
            mStatsLiveData = new MutableLiveData<>();
        }
    ...
    public void requestStats(RequestStats requestStats) {
        DataRepository.Companion.getInstance().getStats(requestStats, mStatsLiveData);
    }
}
